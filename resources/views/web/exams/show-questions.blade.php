        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div id="aside" class="col-md-3">
                    ...
                    <!-- exam details widget -->
                    <ul class="list-group">
                        <li class="list-group-item">{{ __('web.exams_skill') }}: {{ $exam->skill->name() }}</li>
                        <li class="list-group-item">{{ __('web.exams_questions') }}: {{ $exam->questions_no }}</li>
                        <li class="list-group-item">{{ __('web.exams_duration') }}: {{ $exam->duration_mins }}</li>
                        <li class="list-group-item">{{ __('web.exams_difficulty') }}: 
